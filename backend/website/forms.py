...
class ContactForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "email": forms.EmailInput(attrs={"class": INPUT_CLASS, "placeholder": "your@email.com"}),
            "message": forms.Textarea(attrs={"class": INPUT_CLASS, "placeholder": "How can we help?", "rows": 5}),
        }
