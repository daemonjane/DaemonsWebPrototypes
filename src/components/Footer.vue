...
<template>
  <footer id="main-footer" class="bg-slate-900 border-t border-slate-800 mt-16 sm:mt-20">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-2 md:col-span-1 space-y-3">
          <router-link to="/" class="text-lg font-bold text-white tracking-tight">
            <span class="text-gold-400">&lt;</span>VERTEX<span class="text-gold-400">/&gt;</span>
          </router-link>
          <p class="text-xs text-slate-500 leading-relaxed">High-tier hardware, precision-sourced. Direct vendor supply chains, real-time market intelligence.</p>
        </div>

        <!-- Navigation -->
        <div class="space-y-3">
          <h3 class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Navigate</h3>
          <ul class="space-y-2">
            <li><router-link to="/shop" class="text-sm text-slate-500 hover:text-cyan-400 transition-colors">Shop All</router-link></li>
        ...
        <div class="space-y-3">
          ...
          <ul class="space-y-2">
            <li><router-link to="/contact" class="text-sm text-slate-500 hover:text-cyan-400 transition-colors">Contact</router-link></li>
        ...
        <div class="col-span-2 md:col-span-1 space-y-3">
          ...
          <form @submit.prevent="subscribeNewsletter" class="flex gap-2">
            ...
            <button type="submit" class="bg-cyan-600 text-white px-3 py-2 rounded-md text-xs font-semibold hover:bg-cyan-500 transition-colors" aria-label="Subscribe to newsletter">Subscribe</button>
          </form>
          <p v-if="newsletterMsg" class="text-xs text-slate-400 mt-1">{{ newsletterMsg }}</p>
          <div class="flex gap-3 pt-1">
            <a href="https://x.com/vertexhw" target="_blank" rel="noopener noreferrer" class="text-slate-600 hover:text-gold-400 transition-colors" aria-label="Twitter">
            ...
            <a href="https://github.com/daemonjane" target="_blank" rel="noopener noreferrer" class="text-slate-600 hover:text-cyan-400 transition-colors" aria-label="GitHub">
            ...
            <a href="https://discord.gg/vertex" target="_blank" rel="noopener noreferrer" class="text-slate-600 hover:text-gold-400 transition-colors" aria-label="Discord">
