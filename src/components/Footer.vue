    ...
    <div class="max-w-7xl mx-auto px-4 py-10 sm:py-12">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div class="col-span-2 md:col-span-1 space-y-3">
          ...
          <p class="text-xs text-slate-500 leading-relaxed">Verified high-performance hardware. Direct vendor sourcing. Real-time market insights.</p>
        </div>
        ...
        <div class="col-span-2 md:col-span-1 space-y-3">
          ...
          <div class="flex gap-3 pt-1">
            <a href="https://x.com/techstore" target="_blank" rel="noopener noreferrer" class="text-slate-600 hover:text-cyan-400 transition-colors" aria-label="Twitter">
            ...
            <a href="https://discord.gg/techstore" target="_blank" rel="noopener noreferrer" class="text-slate-600 hover:text-cyan-400 transition-colors" aria-label="Discord">
