...
<template>
  <div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <h1 class="text-3xl font-bold font-display text-surface-50 mb-2">Contact Us</h1>
    <p class="text-surface-400 mb-8">Have a question about a product, build, or order? We're here to help.</p>

    <div class="grid md:grid-cols-2 gap-8">
      <div>
        <div class="bg-surface-900 p-6 rounded-xl border border-surface-700">
          <h2 class="text-xl font-semibold font-display text-surface-50 mb-4">Send a Message</h2>
      ...
      <div class="space-y-6">
        <div class="bg-surface-900 p-6 rounded-xl border border-surface-700 space-y-4">
        ...
        <div class="bg-surface-900 p-6 rounded-xl border border-surface-700">
          <h2 class="text-xl font-semibold font-display text-surface-50 mb-3">Business Hours</h2>
          <div class="space-y-2 text-sm text-surface-400">
            <div class="flex justify-between"><span>Monday - Friday</span><span class="text-surface-200">9:00 AM - 6:00 PM</span></div>
            <div class="flex justify-between"><span>Saturday</span><span class="text-surface-200">10:00 AM - 4:00 PM</span></div>
            <div class="flex justify-between"><span>Sunday</span><span class="text-surface-200">Closed</span></div>
          </div>
        </div>
      </div>
    </div>
