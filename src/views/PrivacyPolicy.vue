...
<template>
  <div class="max-w-3xl mx-auto px-4 py-12">
    ...
    <!-- Table of Contents -->
    <div class="bg-surface-900 rounded-xl border border-surface-700 p-5 mb-8">
      <button @click="tocOpen = !tocOpen" class="flex items-center justify-between w-full text-left">
        <span class="text-sm font-semibold text-surface-50">Table of Contents</span>
        <svg class="w-4 h-4 text-surface-400 transition-transform" :class="{ 'rotate-180': tocOpen }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="space-y-8 text-sm leading-relaxed">
      <section id="information">
        <h2 class="text-xl font-semibold text-surface-50 font-display mb-3">1. Information We Collect</h2>
        <p class="text-surface-400">We collect information you provide directly when creating an account, placing an order, or contacting support. This includes your name, email address, shipping address, and payment details. We also automatically collect certain technical data such as IP address, browser type, and device information through standard analytics and cookies.</p>
      </section>

      <section id="use">
        <h2 class="text-xl font-semibold text-surface-50 font-display mb-3">2. How We Use Your Information</h2>
        <p class="text-surface-400">Your information is used to process orders, deliver products, send order updates, provide customer support, improve our services, and comply with legal obligations. We may send promotional emails if you opt in; you can unsubscribe at any time.</p>
      </section>

      <section id="sharing">
        <h2 class="text-xl font-semibold text-surface-50 font-display mb-3">3. Data Sharing & Third Parties</h2>
        <p class="text-surface-400">We do not sell your personal data. We share information with trusted third-party service providers who assist in payment processing, shipping, analytics, and email delivery. These providers are contractually bound to protect your data.</p>
      </section>

      <section id="security">
        <h2 class="text-xl font-semibold text-surface-50 font-display mb-3">4. Data Security</h2>
        <p class="text-surface-400">We implement industry-standard encryption (TLS 1.3) for all data in transit. Payment information is processed by PCI-compliant gateways and is never stored on our servers. Access to personal data is restricted to authorized personnel only.</p>
      </section>
