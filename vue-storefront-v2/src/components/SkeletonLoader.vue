...
<template>
  <div class="animate-pulse space-y-6">
    ...
    <div v-else-if="type === 'detail'" class="grid md:grid-cols-2 gap-8">
      <div class="h-72 sm:h-96 bg-slate-800 rounded-xl"></div>
      <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-2 pt-4">
          <div v-for="i in 4" :key="i" class="h-10 bg-slate-800 rounded-lg"></div>
        </div>
    ...
    <div v-else-if="type === 'list'" class="space-y-4">
      <div v-for="i in 4" :key="i" class="flex gap-4 items-center">
        <div class="w-16 h-16 bg-slate-800 rounded-lg shrink-0"></div>
